...
## الأهداف الرسمية المعتمدة

الهدف العام: **دراسة طرق دمج تقنية سلاسل الكتل Blockchain مع شبكات المركبات اللاسلكية VANET وتقييم أداءها وتشمل:**
...
النص الرسمي وربطه بالأدلة موثق في `docs/OBJECTIVES.md`.
...
- قورنت تجريبياً طرق دمج مختلفة لتحقيق تبادل رسائل موثقة/موقعة مع تثبيت Ed25519 بين المسارات لضبط المقارنة؛ أما مقارنة cryptographic primitives المختلفة (PKI/Group/Ring/Threshold Ring وغيرها) فلم تُنفذ كbenchmark تجريبي وتبقى خارج نطاق الحملة.
